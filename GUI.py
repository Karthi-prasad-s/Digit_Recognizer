...
# Label
# Antiquewhite colour
L1 = Label(window, text="Digit Recognizer", font=('Sans-serif', 25), fg="blue", bg = '#faebd7')
L1.place(x=35, y=10)

# Button to clear canvas
b1 = Button(window, text="Clear", font=('Roboto', 15), bg="white", fg="black", command=clear_widget)
b1.place(x=120, y=370)

# Button to predict digit drawn on canvas
b2 = Button(window, text="Recognize", font=('Roboto', 15), bg="white", fg="red", command=MyProject)
